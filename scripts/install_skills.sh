...
echo ""
echo "═══════════════════════════════════════════════════════════"
echo "  QUICK START - One Command Pipeline"
echo "═══════════════════════════════════════════════════════════"
echo ""
echo "  /optim-pipeline 24 4 4 1800 ./optim_logs"
echo ""
echo "  This SINGLE command runs everything:"
echo "    → Launches 24 optimization agents"
echo "    → Monitors progress with smart detection"
echo "    → Runs GPU benchmarks on successful builds"
echo "    → Verifies integrity (anti-triche)"
echo "    → Generates final markdown report"
echo ""
echo "═══════════════════════════════════════════════════════════"
echo "  INDIVIDUAL SKILLS (for advanced usage)"
echo "═══════════════════════════════════════════════════════════"
echo ""
echo "  /optim-orchestrator 24 4 4 1800 ./optim_logs"
echo "  /optim-benchmark 24 <SESSION_ID> 10 2 \"3D_Large\""
echo "  /optim-antitriche 24 <SESSION_ID>"
echo "  /optim-report 24 <SESSION_ID>"
echo ""
