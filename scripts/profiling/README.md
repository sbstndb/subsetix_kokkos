...
./scripts/profile_benchmark.sh experimental-cuda-profile space-time-stack ".*SmallConfig" -s 5
...
./scripts/profile_benchmark.sh experimental-cuda-profile space-time-stack ".*SmallConfig"
```
