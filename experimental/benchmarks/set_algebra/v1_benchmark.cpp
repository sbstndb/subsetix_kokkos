...
static void BM_Intersection2D_Overlapping(benchmark::State& state) {
...
BENCHMARK(BM_Intersection2D_Overlapping)->Range(64, 8192);

// ============================================================================
// 3D Mesh Intersection Benchmark
// ============================================================================

static void BM_Intersection3D_Overlapping(benchmark::State& state) {
  const int n = state.range(0);
...
BENCHMARK(BM_Intersection3D_Overlapping)->Range(64, 8192);
