...
# Nsight (CUDA)
cmake --preset profiling-nsight-cuda-gcc14 && cmake --build --preset profiling-nsight-cuda-gcc14
...
**Build presets**:
- `profiling-nsight-cuda-gcc14` - RelWithDebInfo build
- `profiling-nsight-cuda-gcc14-release` - Release with debug symbols
...
- `experimental-cuda-gcc14-profile` - CUDA + Kokkos tools
...
| `experimental-cuda-gcc14-profile` | CUDA | `build-experimental-cuda-gcc14-profile` | `SUBSETIX_ENABLE_PROFILING_KOKKOS=ON` |
| `profiling-nsight-cuda-gcc14` | CUDA | `build-profiling-nsight-cuda-gcc14` | `SUBSETIX_ENABLE_PROFILING_CUDA=ON` |
| `profiling-nsight-cuda-gcc14-release` | CUDA | `build-profiling-nsight-cuda-gcc14-release` | `SUBSETIX_ENABLE_PROFILING_CUDA=ON` |
