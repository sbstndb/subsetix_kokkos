# Complex Geometry with Mixed Shapes
...
![Complex Geometry with Mixed Shapes](output/04_complex_geometry.png)

*Figure: Complex Geometry with Mixed Shapes*
...
int main(int argc, char** argv) {
    ...
    geom.add_rectangle(0.0f, 0.1f, 0.3f, 0.7f, true);
    geom.add_rectangle(0.0f, 0.1f, 0.3f, 0.35f, false);  
    geom.add_rectangle(0.0f, 0.1f, 0.65f, 0.7f, false); 
